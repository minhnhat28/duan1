            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Đơn Hàng Đã Giao Thành Công</h4>
                    </div>
                    <div class="card-body">
                ...
                <span>
                    ...
                    ?>
                        <a class="paginate_button current" href="index.php?act=list_completed_order&page=<?= $i ?>" aria-controls="example" data-dt-idx="1" tabindex="0">
                            <?= $i + 1 ?>
                        </a>
                    <?php
                    }
