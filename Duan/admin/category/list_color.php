                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?=$id_color?></td>
                                            <td><?=$color_name?></td>
                                            <td><a  href="index.php?act=update_color&id=<?=$id_color?>"><button class="btn btn-primary">Sửa</button></a></td>
                                            <td>
                            ...
                            <div class="dataTables_paginate paging_simple_numbers" id="example_paginate">
                                ...
                                <span>
                                    <?php
                                        for ($i=0; $i < $count; $i++) {
                                    ?>
                                    <a class="paginate_button current" href="index.php?act=list_color&page=<?=$i?>" aria-controls="example" data-dt-idx="1" tabindex="0"><?=$i+1?></a>
                                    <?php
                                     }
                                    ?>
                                </span>
